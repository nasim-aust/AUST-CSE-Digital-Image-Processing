...
A = im2double(rgb2gray(imread('C:\Users\Student\Desktop\Template_Matching\input\input.jpg')));
B = im2double(rgb2gray(imread('C:\Users\Student\Desktop\Template_Matching\template_whole\chartemp1.jpg')));
